...
export const metadata: Metadata = {
  ...
  description:
    "Doctoral dissertation editing for New Jersey candidates. Methodology alignment, APA 7 verification, citation cross-check, and a 0–100 readiness score in 24 hours. From $29 per review, 14-day money-back guarantee.",
