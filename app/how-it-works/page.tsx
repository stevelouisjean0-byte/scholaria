...
const HOWTO = howTo({
  name: "How a manuscript is reviewed by the Dissertation Editing Center system",
  description:
    "The pipeline a doctoral or graduate manuscript moves through — from upload to delivered package — with named agents for intake, methodology, citation, editing, and QA.",
  totalTime: "PT45M",
  steps: [
    ...
    { name: "Orchestration", text: "The Orchestrator Agent assigns the reviewing agents, maintains the shared workflow memory, and drives deterministic state transitions across the pipeline." },
...
export const metadata: Metadata = {
  ...
  description:
    "From upload to delivery — a coordinated multi-agent review pipeline with shared memory, deterministic orchestration, and QA-gated transitions. 24-hour turnaround on Doctoral; 6–12 on Dissertation Intensive.",
