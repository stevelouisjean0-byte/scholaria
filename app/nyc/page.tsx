...
export const metadata: Metadata = {
  ...
  description:
    "Doctoral dissertation editing for New York City candidates. Methodology alignment, APA 7 verification, citation cross-check, and a 0–100 readiness score in 24 hours. Free first review.",
