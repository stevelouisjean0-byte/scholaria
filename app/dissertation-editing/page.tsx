...
export const metadata: Metadata = {
  ...
  description:
    "Chapter-grade dissertation editing for Ph.D., Ed.D., and DBA candidates. Methodology alignment, APA 7 verification, citation cross-check, and submission readiness scoring delivered in 24 hours. From $29 per review · view a public sample first.",
