    ...
    >
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.footer} fixed>
          <Text>Template — not executed. Final version: enterprise@dissertationeditingcenter.com · Dissertation Editing Center, 8315 Northern Blvd Ste 2, Jackson Heights, NY 11372</Text>
          <Text>v1.0 · 2026</Text>
        </View>
      </Page>
    </Document>
