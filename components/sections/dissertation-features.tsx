      ...
      <div className="container">
        ...
        <div className="grid grid-cols-12 gap-x-10 gap-y-6 items-end">
          ...
          <p className="col-span-12 lg:col-span-5 text-[15px] leading-[1.75] text-ink-700 lg:border-l lg:border-ink-200 lg:pl-8">
            Each is performed by the agent best suited to it and merged into a single canonical revision
            document. None of them rewrite your work — they tell you, precisely, what to revise.
          </p>
        </div>
